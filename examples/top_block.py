...
# Title: Top Block
# Generated: Wed Jul 29 21:26:07 2020
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._threshold_range = Range(0, 1000, 0.1, 10, 200)
        ...
        self.chirp_mod_0 = chirp.mod(BW, samp_rate, hamming)
        self.chirp_demod_0 = chirp.demod(BW, samp_rate, hamming, threshold)
        self.blocks_socket_pdu_1 = blocks.socket_pdu("UDP_CLIENT", 'localhost', '52002', 10000, False)
        self.blocks_socket_pdu_0 = blocks.socket_pdu("UDP_SERVER", 'localhost', '52001', 10000, False)

        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.blocks_socket_pdu_0, 'pdus'), (self.chirp_mod_0, 'in'))
        self.msg_connect((self.chirp_demod_0, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.connect((self.chirp_mod_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.chirp_demod_0, 0))
